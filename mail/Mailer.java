...
//      define a variável para colocar a imagem no e-mail
...
// 			true => multipart. Indica que vai enviar imagens
			MimeMessageHelper helper = new MimeMessageHelper(mimeMessage, true, "UTF-8");
			helper.setFrom("jcvdtc@gmail.com");
			helper.setTo(venda.getCliente().getEmail());
			helper.setSubject(String.format("Brewer - Venda no. %d", venda.getCodigo()));
//			true => é um e-mail html
			helper.setText(email, true);
//			Adiciona a imagem logo-gray.png para aparecer na variável "logo" no ResumoVenda.html			
